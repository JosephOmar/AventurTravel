...
export const NATIONAL_TOURS = [
  {
    name: 'Amazonas',
    img: '/img/National/Amazonas.webp',
    description: 'Sumérgete en la exuberante selva amazónica, hogar de una biodiversidad asombrosa y paisajes inexplorados.',
    link: './amazonas',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    description: 'Descubre la majestuosidad de la Cordillera Blanca y la cultura andina en Ancash, un paraíso para los amantes de la aventura.',
    link: './ancash',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    description: 'Maravíllate con los imponentes paisajes del Cañón del Colca y explora la arquitectura colonial de la Ciudad Blanca, Arequipa.',
    link: './arequipa',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    description: 'Descubre la encantadora ciudad de Cajamarca, hogar de una rica historia y maravillosos tesoros culturales. ',
    link: './Cajarmarca',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    description: 'Embárcate en una travesía por la historia inca en Cusco, la antigua capital del imperio, y descubre la magia de Machu Picchu.',
    link: './cusco',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    description: 'Embárcate en una aventura única en Huancavelica, un destino de ensueño en medio de los Andes Nationalanos.',
    link: './huancavelica',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    description: 'Navega por el río Amazonas desde Iquitos, la puerta de entrada a la selva, para explorar la flora y fauna única de la región.',
    link: './iquitos',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    description: 'Sumérgete en la riqueza cultural de Lambayeque, hogar de las famosas tumbas reales de Sipán y el impresionante Museo Tumbas Reales.',
    link: './lambayeque',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    description: 'Disfruta de las playas paradisíacas de Piura, donde el sol y el mar se combinan para ofrecer un refugio perfecto.',
    link: './piura',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    description: 'Embárcate en una experiencia única en el Lago Titicaca, explorando las islas flotantes de los Uros y la mística Isla Taquile.',
    link: './puno',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  }
...
export const INTERNATIONAL_TOURS = [
  {
    name: 'Sudamérica',
...
export const SUDAMERICA_TOURS = [
  ...
  },
  {
    ...
    link: './Sudamerica/colombia',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  }
]

export const CARIBE_TOURS = [
  {
    name: 'Cancún',
  ...
  },
  {
    ...
    link: './Caribe/punta-cana',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  }
]

export const NORTEAMERICA_TOURS = [
  {
    name: 'México',
  ...
  },
  {
    ...
    link: './Norteamerica/estados-unidos',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  }
]

export const WEEKEND_TOURS = [
  {
    name: 'Huacho',
  ...
  },
  {
    ...
    link: './Weekend/lunahuana',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  }
]

export const FULLDAYS_TOURS = [
  {
    name: 'Lunahuana',
...
export const VIAJEESCOLAR_TOURS = [
  {
    ...
    link: './Viaje-De-Estudios/chiclayo',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    link: './Viaje-De-Estudios/arequipa',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    link: './Viaje-De-Estudios/trujillo',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
...
export const VISITAESCOLAR_TOURS = [
  {
    ...
    link: './Visita-De-Estudios/real-felipe',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    link: './Visita-De-Estudios/museo-de-arte-de-lima',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    link: './Visita-De-Estudios/museo-de-la-nacion',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    link: './Visita-De-Estudios/planetario-de-lima',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  }
]
...
export const PROMOCIONESCOLAR_TOURS = [
  {
    ...
    link: './Viaje-De-Promocion/trujillo',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    description: 'Disfruta de un día lleno de emociones en Lunahuaná, donde podrás practicar deportes de aventura como el rafting y la canotaje, rodeado de paisajes impresionantes.',
    link: './Viaje-De-Promocion/huancayo',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    description: 'Disfruta de un día lleno de emociones en Lunahuaná, donde podrás practicar deportes de aventura como el rafting y la canotaje, rodeado de paisajes impresionantes.',
    link: './Viaje-De-Promocion/cajamarca',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    description: 'Disfruta de un día lleno de emociones en Lunahuaná, donde podrás practicar deportes de aventura como el rafting y la canotaje, rodeado de paisajes impresionantes.',
    link: './Viaje-De-Promocion/chiclayo',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
    ...
    description: 'Disfruta de un día lleno de emociones en Lunahuaná, donde podrás practicar deportes de aventura como el rafting y la canotaje, rodeado de paisajes impresionantes.',
    link: './Viaje-De-Promocion/paracas',
    option1: 'lg:w-[450px] max-w-[400px] min-w-[360px]',
    option2: ''
  },
  {
